...
docker pull ghcr.io/roysomak4/fgfr1-itd-seeker:latest

This the easiest way to get started, without having to worry about installing any dependencies for VarDict caller
